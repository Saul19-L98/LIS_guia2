...
<head>
    ...
    <link rel="stylesheet" media="screen" href="./css/conversaion.css"/>
</head>
<body>
    <?php
        define("SALTO", "\n");
        ...
        //Construyendo el haber
        echo "<header> \n";
        echo "\t<h1>Trabajando con los tipo de datos en PHP </h1>\n";
        echo "\t<p id=\"datos\">\n";
        echo "\t\tVariables:<br />\n";
        echo "\t\t\$cad = \"$cad\"<br />\n";
        echo "\t\t\$str = \"$str \"<br />\n";
        ...
        $concat = $str + $cad;
        echo "<article";
        echo '<p>El valor de $concat = $str + $num es: <span> = "'. $str . '" + ' . $cad .'</span> = <span>';
        echo $concat . '</span> y el tipo de dato es: <span>' . gettype($concat) . "</span></p>" . SALTO;
        echo '</article';
        echo "\n";
        echo '</section>';
